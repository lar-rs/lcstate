 ...
 *
 * (c) 2013-2014 hj.oertel@t-online.de
 *
...
#if defined(DEBUG)
#ifdef __x86_64__
	    pr_info(" Base[%d] address %llx\n", i, (long long unsigned)proc_base[i]);
#else
...
void __iomem *led_ptr = (canregs_t *)proc_base[minor];
...
{
void __iomem *term_ptr = (canregs_t *)proc_base[minor];
