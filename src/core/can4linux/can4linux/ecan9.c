...
u32 clock_freq;
	...
	this normally should be done by calling
		clk_enable(&ckie_clk);
	*/
	...
	/* proc_clock frequency got from the device tree information */
	...
	{
		/* only informative, values are set static in core.c */
		int irq;
