 ...
 *------------------------------------------------------------------
 * $Header: /z2/cvsroot/products/0530/software/can4linux/src/bf537.h,v 1.2 2007/10/29 15:59:10 oe Exp $
 *
 *--------------------------------------------------------------------------
 *
 *
 ...
 * --------------------
 * $Log: bf537.h,v $
 * Revision 1.2  2007/10/29 15:59:10  oe
 * - updates with bit rate table for CAN_SYSCLK == 120
 *
...
#endif
#if CAN_SYSCLK == 120
    #define CAN_BRP_100K		59
    #define CAN_TSEG_100K		0x002f
    #define CAN_BRP_125K		59
    #define CAN_TSEG_125K		0x001c
    #define CAN_BRP_250K		29
    #define CAN_TSEG_250K		0x001c
    #define CAN_BRP_500K		14
    #define CAN_TSEG_500K		0x001c
    #define CAN_BRP_800K		9
    #define CAN_TSEG_800K		0x001b
    #define CAN_BRP_1000K		7
    #define CAN_TSEG_1000K		0x001b
