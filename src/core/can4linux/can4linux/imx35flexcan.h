...
/* Bit values of the FlexCAN error and status register  HW_CAN_ESR
25.6.8 Error and Status Register (HW_CAN_ESR) field descriptions
*/
...
#define CAN_ESTAT_ACK_ERR		0x2000	/* This bit indicates that an Acknowledge Error has been detected by the transmitter node */
...
#define CAN_ESTAT_IDLE			0x0080	/* This bit indicates when CAN bus is in IDLE state */
#define CAN_ESTAT_TX_RX			0x0040	/* This bit indicates if CAN is transmitting or receiving a message when the CAN bus is not in IDLE state */
#define CAN_ESTAT_FCS 			0x0030	/* Confinement State of the CAN module */
#define CAN_ESTAT_FCS0			0x0010	/* Error Passive */
#define CAN_ESTAT_FCS1			0x0020	/* Bus Off */
#define CAN_ESTAT_BOFF_INT		0x0004	/* This bit is set when CAN enters Bus Off state */
#define CAN_ESTAT_ERR_INT		0x0002	/* This bit indicates that at least one of the Error Bits (bits 15-10) is set */
...
#define CAN_OBJ \
   ((struct can_obj volatile __iomem *) (((void __iomem *)can_iobase[minor]) + 0x80))
