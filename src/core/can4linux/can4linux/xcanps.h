...
typedef struct canregs {
	...
	u32	txhpb_id;	/* transmit high priority buffer message id */
	u32	txhpb_dlc;	/* transmit high priority buffer dlc	    */
...
/* 100 Mhz */
#if CAN_SYSCLK == 100000000
#  define CAN_BRPR_10K		0x00
#  define CAN_BTR_10K		0xFF /* not possible */
#  define CAN_BRPR_20K		0xf9
#  define CAN_BTR_20K		0x2f
#  define CAN_BRPR_50K		0x7c
#  define CAN_BTR_50K		0x1c
#  define CAN_BRPR_100K         0x31 
#  define CAN_BTR_100K          0x2f
#  define CAN_BRPR_125K		0x31
#  define CAN_BTR_125K		0x1c
#  define CAN_BRPR_250K		0x18
#  define CAN_BTR_250K		0x1c
#  define CAN_BRPR_500K		0x09
#  define CAN_BTR_500K		0x2f
#  define CAN_BRPR_800K		0x04
#  define CAN_BTR_800K		0x7f
#  define CAN_BRPR_1000K	0x04
#  define CAN_BTR_1000K		0x2f
...
#  error Please specify a valid CAN_SYSCLK value (i.e. 8, 10) \
