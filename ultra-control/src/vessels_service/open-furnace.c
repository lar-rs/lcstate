...
static void open_furnace_done(GObject *source_object, GAsyncResult *res, gpointer user_data) {
    ...
    FURNACE_SET_OPEN(ULTRA_FURNACE_OBJECT(g_task_get_source_object(G_TASK(res))),TRUE);
...
void open_furnace_operation(UltraFurnaceObject *furnace, GCancellable *cancellable, GDBusMethodInvocation *invocation) {
    GTask * task  = g_task_new(furnace, cancellable, open_furnace_done, g_object_ref(invocation));
...
void START_timeout_callback(GObject *source_object, GAsyncResult *res, gpointer user_data) {
    ...
    nodes_digital16_call_set_digital_out(FURNACE_DIGITAL1(furnace), FURNACE_CLOSE_bit, FALSE, g_task_get_cancellable(task), OUT_CLOSE_BIT_callback, task);
}
...
void OUT_CLOSE_BIT_callback(GObject *source_object, GAsyncResult *res, gpointer user_data) {
    ...
    nodes_digital16_call_set_digital_out(FURNACE_DIGITAL1(furnace), FURNACE_OPEN_bit, TRUE, g_task_get_cancellable(task), OUT_OPEN_BIT_callback, task);
}
...
void OUT_OPEN_BIT_callback(GObject *source_object, GAsyncResult *res, gpointer user_data) {
    ...
    nodes_digital16_call_get_digital_in(NODES_DIGITAL16(source_object), FURNACE_IS_OPEN_bit, g_task_get_cancellable(task), IN_OPEN_BIT_callback, task);
}
...
void IN_OPEN_BIT_callback(GObject *source_object, GAsyncResult *res, gpointer user_data) {
    ...
    if (!nodes_digital16_call_get_digital_in_finish(NODES_DIGITAL16(source_object), &result, res, &error)) {
        ...
        if (g_timer_elapsed(timer, NULL) > 5.0 && g_timer_elapsed(timer, NULL) < 5.5) {
            nodes_digital16_call_set_digital_out(FURNACE_DIGITAL1(furnace), FURNACE_OPEN_bit, FALSE, g_task_get_cancellable(task), OUT_OPEN_BIT_CLOSE_callback, task);
...
void WAITE_timeout_callback(GObject *source_object, GAsyncResult *res, gpointer user_data) {
    ...
    UltraFurnaceObject *furnace = ULTRA_FURNACE_OBJECT(g_task_get_source_object(task));
    nodes_digital16_call_get_digital_in(FURNACE_DIGITAL1(furnace), FURNACE_IS_OPEN_bit, g_task_get_cancellable(task), IN_OPEN_BIT_callback, task);
}
...
void OUT_OPEN_BIT_CLOSE_callback(GObject *source_object, GAsyncResult *res, gpointer user_data) {
    ...
    nodes_digital16_call_set_digital_out(FURNACE_DIGITAL1(furnace), FURNACE_CLOSE_bit, TRUE, g_task_get_cancellable(task), OUT_CLOSE_BIT_OPEN_callback, task);
}
