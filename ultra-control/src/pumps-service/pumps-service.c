...
#define __LOG_DOMAIN    ((gchar*) "com.lar.tera.pumps")

/*
static void
critical_message_dummy(const gchar *log_domain,
...
//	g_setenv ("G_MESSAGES_DEBUG", "all", TRUE);
	...
	tera_service_new_user_session(PUMPS_TYPE_APPLICATION_OBJECT,TERA_PUMPS_NAME);
